...
banned = cluster["OmUtilities"]["bans"]
...
class Miscellaneous(commands.Cog, description="Other miscellaneous commands."):
    ...
    @commands.command(
        ...
        brief="View OmUtilities's information",
    ...
    async def info(self, ctx):
        ...
        embed = discord.Embed(
            title="OmUtilities Stats and Information", colour=self.client.colour
        )
        ...
        embed.add_field(
            name="Source code",
            value="View the bot's source code on [GitHub](https://github.com/Omcodez1503)",
            inline=False,
        )
        embed.add_field(
            name="Developer",
            value="[President Om](http://omtecheducation.tk)",
            inline=False,
        )
    ...
    async def suggest(self, ctx, *, suggestion):
        ...
        # Get OmUtilities support server's suggestions channel
        channel = self.client.get_channel(884795780999823360)
        ...
        await ctx.send(
            "✅ Your suggestion has been submitted to OmUtilities's server! A link to the server can be found in my About Me, or the `info` command.",
        )
    ...
    async def upvote(self, ctx):
        embed = discord.Embed(
            title="Upvote OmUtilities",
            description="Help OmUtilities grow by upvoting it on Top.gg!\n\nLink to upvote: **https://top.gg/bot/884080176416309288/vote**",
    ...
    # Changelog
    @commands.command(help="See what's new in the latest version of OmUtilities")
    async def changelog(self, ctx):
        changelog = discord.Embed(
            title=f"What's new in version {__version__} of OmUtilities",
            colour=self.client.colour,
            description="Whoo, OmUtilities is growing.\n\n"
            ...
            + "- Optimised OmUtilities to consume slightly lesser resources as it's growing fast now.\n"
    ...
    @cog_ext.cog_slash(
        name="changelog", description="See what's new in the latest version of OmUtilities"
    )
